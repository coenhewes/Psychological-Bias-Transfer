...
gemini_files = sorted(glob.glob("/home/forge/Psychological-Bias-Transfer/eval_outputs/judged_llama/*.judged.jsonl"))
...
with open("/home/forge/Psychological-Bias-Transfer/eval_outputs/kappa_gemini_vs_gptoss.json", "w") as f:
